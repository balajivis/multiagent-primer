...
> SDRAuto — a small SaaS that automates outbound SDR (sales development rep) workflows. The team is mid-sprint: shipping v1.4 (which includes the auth + signup work in `sandbox/`), planning the tech-debt sprint after it, and chasing two production bugs.
